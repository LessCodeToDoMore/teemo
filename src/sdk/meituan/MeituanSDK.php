...
//        $data['delivery_id'] = 775466017754660145;
//        $data['order_id'] = "P2017230714545";
//        $data['shop_id'] = 'test_0001';
//        $data['delivery_service_code'] = "4013";
//        $data['receiver_name'] = "瓜炒茄";
//        $data['receiver_address'] = "华润置地大厦E座5楼";
//        $data['receiver_phone'] = "15626268141";
//        $data['receiver_lat'] = "113944163";
//        $data['receiver_lng'] = "22553222";
//        $data['expected_delivery_time'] = time() + 3600 * 26;
//        $data['poi_seq'] = 'A123456';
